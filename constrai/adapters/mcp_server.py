"""
constrai/adapters/mcp_server.py — ConstrAI safety wrapper for MCP tool servers.
...
Usage:
    from constrai.adapters.mcp_server import SafeMCPServer
    from constrai import Invariant, no_action_after_flag_invariant
...
class SafeMCPServer:
    """A ConstrAI-guarded wrapper around FastMCP.
    ...
    def tool(
        ...
        *,
        ...
        """Decorator to register a function as a ConstrAI-guarded MCP tool.
            ...
            def safe_handler(*args: Any, **kwargs: Any) -> Any:
                with self._lock:
                    ...
                    if not verdict.approved:
                        ...
                        raise SafetyViolation(
                            f"Tool '{tool_name}' blocked by ConstrAI: {reasons}"
                        )
