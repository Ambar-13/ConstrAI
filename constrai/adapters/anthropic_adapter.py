"""
constrai.adapters.anthropic_adapter — Claude API adapters (sync and async).
...
Requires: pip install constrai[anthropic]
"""
...
class AnthropicAdapter:
    """
    ConstrAI LLM adapter for the Anthropic Python SDK.
