"""
constrai.adapters.openai_adapter — OpenAI Chat Completions adapters (sync and async).
...
Native-async adapter (``AsyncOpenAIAdapter``):
    import openai
    from constrai.adapters import AsyncOpenAIAdapter
...
Requires: pip install constrai[openai]
"""
...
class OpenAIAdapter:
    """
    ConstrAI LLM adapter for the OpenAI Python SDK (v1.x).
