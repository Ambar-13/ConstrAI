"""
constrai.invariants — Pre-built safety invariant library.
...
def rate_limit_invariant(
    ...
    *,
    ...
    """
    _sug = suggestion or f"Reduce the value of '{key}' below {max_count} before proceeding."
    return Invariant(
        f"rate_limit:{key}",
...
def resource_ceiling_invariant(
    ...
    *,
    ...
    """
    _sug = suggestion or f"Keep '{key}' at or below {ceiling}."
    return Invariant(
...
def value_range_invariant(
    ...
    *,
    ...
    """
    _sug = suggestion or f"Set '{key}' to a value between {min_val} and {max_val}."
    return Invariant(
        f"value_range:{key}",
...
def max_retries_invariant(
    ...
    *,
    ...
    """
    _sug = suggestion or f"The action has been retried {limit} times. Escalate or abort."
    return Invariant(
        f"max_retries:{key}",
...
def no_delete_invariant(
    ...
    *,
    ...
    """
    _sug = suggestion or f"The field '{key}' must remain present and truthy. Do not delete it."
    return Invariant(
        f"no_delete:{key}",
...
def read_only_keys_invariant(
    ...
    *,
    ...
    key_list = list(keys)
    _sug = (suggestion or
            f"The following fields are read-only: {key_list}. "
            f"Do not propose actions that modify them.")
    return Invariant(
...
def required_fields_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            f"Required fields {field_list} must all be present and non-None.")
    return Invariant(
...
def no_sensitive_substring_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            f"The field '{key}' must not contain sensitive strings: {forbidden_list}.")
    return Invariant(
...
def no_regex_match_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            f"The field '{key}' must not match the pattern '{pattern}'.")
    return Invariant(
        f"no_regex:{key}",
...
def human_approval_gate_invariant(
    ...
    *,
    ...
    """
    _sug = (suggestion or
            f"Set state['{approval_key}'] = True before proceeding. "
...
def no_action_after_flag_invariant(
    ...
    *,
    ...
    """
    _sug = (suggestion or
            f"The flag '{flag_key}' is set. No further actions are permitted.")
    return Invariant(
...
def allowed_values_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            f"'{key}' must be one of {sorted(str(v) for v in allowed_set)}.")
    return Invariant(
...
def monotone_increasing_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            f"'{key}' must not decrease. It has already reached {_max[0]}.")
    return Invariant(
...
def monotone_decreasing_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            f"'{key}' must not increase. It was last seen at {_min[0]}.")
    return Invariant(
...
def non_empty_invariant(
    ...
    *,
    ...
    """
    _sug = suggestion or f"The field '{key}' must not be empty or None."
    return Invariant(
        f"non_empty:{key}",
...
def list_length_invariant(
    ...
    *,
    ...
    """
    _sug = (suggestion or
            f"'{key}' must not exceed {max_length} items. "
            f"Consider batching or cleaning up before adding more.")
    return Invariant(
        f"list_length:{key}",
...
def no_duplicate_ids_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            ...
            f"Deduplicate before adding the new item.")
    return Invariant(
...
def file_operation_limit_invariant(
    ...
    *,
    ...
    """
    _sug = (suggestion or
            f"File operation limit reached ({max_ops}). "
            f"Review changes before proceeding.")
...
def api_call_limit_invariant(
    ...
    *,
    ...
    """
    _sug = (suggestion or
            f"API call limit ({max_calls}) reached. "
            f"Consider caching results or batching requests.")
...
def string_length_invariant(
    ...
    *,
    ...
    """
    _sug = (suggestion or
            f"Keep '{key}' at or below {max_length} characters.")
    return Invariant(
        f"string_length:{key}",
...
def pii_guard_invariant(
    *keys: str,
    ...
    key_list = list(keys)
    _sug = (suggestion or
            f"Remove PII (SSN, CC number, email, phone) from fields: {key_list}.")
...
def time_window_rate_invariant(
    ...
    *,
    ...
    """
    _sug = (suggestion or
            f"No more than {max_count} calls within {window_seconds}s. "
...
def json_schema_invariant(
    ...
    *,
    ...
    _sug = (suggestion or
            f"Ensure '{key}' fields match the expected types: {_schema_frozen}.")
