"""
constrai.testing — Test utilities for verifying ConstrAI safety properties.

Zero runtime dependencies beyond constrai itself.  All helpers are pure Python
and work with any test runner (pytest, unittest, or plain ``assert``).

Usage::

    from constrai.testing import SafetyHarness, make_state, make_action
    from constrai import rate_limit_invariant
