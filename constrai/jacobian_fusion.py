"""constrai.jacobian_fusion — Boundary sensitivity scoring (heuristic).
...
class JacobianFusion:
    ...
    def compute_jacobian(self, state: State) -> JacobianReport:
        ...
        if safety_barrier_violated:
            ...
            recommendation = "WARNING: Monitor constraint boundaries closely; critical variables approaching"
        elif max_score > 0.3:
            recommendation = "INFO: All constraints nominal; continue normal operation"
        else:
            recommendation = "OK: Safe state; all constraints well within margins"
