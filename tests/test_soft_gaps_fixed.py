...
import pytest
from constrai.formal import Effect, State, ActionSpec, GuaranteeLevel
from constrai.reference_monitor import QPProjector, ControlBarrierFunction, ReferenceMonitor
...
# ═══════════════════════════════════════════════════════════════════════════
# §2  QP NUDGING TESTS — Numeric QP Gap
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# §3  REFERENCE MONITOR SAFE VALUE COMPUTATION — Integration Test
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# §4  END-TO-END INTEGRATION: QP Nudging in Orchestration
# ═══════════════════════════════════════════════════════════════════════════
...
class TestQPNudgingIntegration:
    ...
    def test_qp_nudging_e2e_scenario(self):
        ...
        print(f"✓ QP Nudging E2E: Spend nudged from 100 to {100 - new_balance}, balance: {new_balance}")
...
class TestBackwardCompatibility:
    ...
    def test_qp_projector_backward_compat(self):
        ...
        repaired, was_changed = projector.project_action(
            action, state, constraints=[]
        )
